...
do
	...
	do
		...
		cd ../../../../..
		./gradlew clean :xo-opportunity-trader:test --tests com.gtc.opportunity.trader.service.nnopportunity.global.GlobalNnPerformanceTest.test &> "/home/valb3r/Desktop/log/g"$gain"_l"$level".log"
	done
done
